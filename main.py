...
parser.add_argument('--data_test', metavar = 'DIR', default = '/raid/liqiufu/DATA/ILSVRC2012',
                    help = 'path to dataset')
parser.add_argument('--root_save', metavar = 'DIR', default = './Result',
...
def main_worker(gpu, args, printer):
    ...
    if args.pretrained:
        ...
        import models_dwt.densenet_HWCEP_Mix_HL_DEF_1
        ...
        if (args.arch == 'vgg11_bn_dwt'):
            ...
            model = models_dwt.densenet_HWCEP_Mix_HL_DEF_1.densenet121(wavename = args.wavename)
        elif (args.arch == 'densenet169_dwt'):
            model = models_dwt.densenet_HWCEP_Mix_HL_DEF_1.densenet169(wavename = args.wavename)
        elif (args.arch == 'densenet201_dwt'):
            model = models_dwt.densenet_HWCEP_Mix_HL_DEF_1.densenet201(wavename = args.wavename)
        elif (args.arch == 'densenet161_dwt'):
            model = models_dwt.densenet_HWCEP_Mix_HL_DEF_1.densenet161(wavename = args.wavename)
